...
ORDERER_CA=$(realpath ${PWD}/../organizations/ordererOrganizations/cne.com/tlsca/tlsca.cne.com-cert.pem);
# Define peer environment variables for CNE
export CORE_PEER_TLS_ENABLED=true;
export CORE_PEER_LOCALMSPID="CNEMSP";
export CORE_PEER_TLS_ROOTCERT_FILE=$(realpath ${PWD}/../organizations/peerOrganizations/cne.com/tlsca/tlsca.cne.com-cert.pem);
...
export CORE_PEER_TLS_ROOTCERT_FILE=$(realpath ${PWD}/../organizations/peerOrganizations/moe.com/tlsca/tlsca.moe.com-cert.pem);
