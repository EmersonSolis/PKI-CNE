...
set -x
fabric-ca-client enroll -u https://admin:adminpw@ca_cne:7054 --caname ca-cne --tls.certfiles "${PWD}/fabric-ca/cne/ca-cert.pem"
{ set +x; } 2>/dev/null
...
cp "${PWD}/fabric-ca/cne/ca-cert.pem" "${PWD}/peerOrganizations/cne.com/tlsca/tlsca.cne.com-cert.pem"
...
set -x
fabric-ca-client enroll -u https://peer0:peer0pw@ca_cne:7054 --caname ca-cne -M "${PWD}/peerOrganizations/cne.com/peers/peer0.cne.com/msp" --csr.hosts peer0.cne.com --tls.certfiles "${PWD}/fabric-ca/cne/ca-cert.pem"
{ set +x; } 2>/dev/null
...
set -x
fabric-ca-client enroll -u https://peer0:peer0pw@ca_cne:7054 --caname ca-cne -M "${PWD}/peerOrganizations/cne.com/peers/peer0.cne.com/tls" --enrollment.profile tls --csr.hosts peer0.cne.com --csr.hosts localhost --tls.certfiles "${PWD}/fabric-ca/cne/ca-cert.pem"
{ set +x; } 2>/dev/null
...
set -x
fabric-ca-client enroll -u https://user1:user1pw@ca_cne:7054 --caname ca-cne -M "${PWD}/peerOrganizations/cne.com/users/User1@cne.com/msp" --tls.certfiles "${PWD}/fabric-ca/cne/ca-cert.pem"
{ set +x; } 2>/dev/null
...
set -x
fabric-ca-client enroll -u https://cneadmin:cneadminpw@ca_cne:7054 --caname ca-cne -M "${PWD}/peerOrganizations/cne.com/users/Admin@cne.com/msp" --tls.certfiles "${PWD}/fabric-ca/cne/ca-cert.pem"
{ set +x; } 2>/dev/null
